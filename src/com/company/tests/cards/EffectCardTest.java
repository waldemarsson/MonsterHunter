...
class EffectCardTest {
    ...
    class EffectCardSuperTest extends EffectCard {
        public EffectCardSuperTest(int id, String name, int value, EffectType effectType) {
    ...
    @Test
    void belowZeroValue(){
        assertEquals(0, new EffectCardSuperTest(2, "", -1, EffectType.STAMINA),
                "Failed to handle negative value of effect card");
    }

    @Test
    void zeroIdForNoneEffect(){
        assertEquals(0, new EffectCardSuperTest(2, "", 0, EffectType.NONE),
